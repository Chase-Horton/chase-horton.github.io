        ...
        <nav className="fixed top-0 left-0 right-0 z-50 border-b border-white/10 bg-background/60 backdrop-blur-md">
            <div className="flex h-16 items-center justify-between px-8 md:px-12 w-full">
                ...
                <div className="flex items-center gap-4">
                    <a
                        href="/rss.xml"
                        className="hover:text-white text-muted-foreground transition-colors p-2"
                        aria-label="RSS Feed"
                        title="RSS Feed"
                    >
                        <Rss className="w-6 h-6 hover:text-white transition-colors" />
                    </a>
                    <a
                        href="https://github.com/chase-horton"
                        target="_blank"
